...
### [ ] BATTLE-01: Integrar Battle/Kombate al frontend
...
### [ ] BATTLE-02: Conectar battle-engine con cartas reales
...
### [ ] DECK-01: Arreglar página "Mis Cartas" (deck.html)
...
### [ ] PAIRS-01: Mostrar imagen de la carta en el tablero (no solo al hacer click)
...
### [ ] PAIRS-02: Animación de volteo de carta (CSS flip)
...
### [ ] ADMIN-01: Importar cartas desde birds/pack-1.json al backend via admin
...
### [ ] BACKEND-01: Endpoint para actualizar tags de cartas existentes
...
### [ ] UI-01: Home page (index.html) con links a todos los juegos
...
### [ ] UI-02: Header consistente en todas las páginas
...
### [ ] BACKEND-02: Endpoint de búsqueda por tags
...
### [ ] PAIRS-04: Guardar historial de partidas en localStorage
...
### [ ] INFRA-01: Script de seed para poblar la DB con birds/pack-1.json
...
### [ ] INFRA-02: Limpiar migración duplicada en Prisma
